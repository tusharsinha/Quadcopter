...
I have to just convert the output into proper format (which are the angles right?? Standard Servo Output)
...
// include the pinchangeint library - see the links in the related topics section above for details......... xxx[Need Installation]
#include <PinChangeInt.h>

#include <Servo.h>     //xxx We will replace this accordingly
...
void loop()
{
  ...
  //xx   Servo output can be (0,180)degrees or in microseconds
  ...
  // For imperfect ones try values between 700 and 2300
  // I have converted the inputs 
  // use val = map(val, 0, 1023, 0, 179);     // scale it to use it with the servo (value between 0 and 180)   [I/O conversion]
  if(bUpdateFlags & THROTTLE_FLAG)
  {
